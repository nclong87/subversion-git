...
<s:url action="ajSearchEvent" namespace="/event" id="ajSearchEventURL"/>
...
<div id="box_form" style="margin: 0pt auto; width: 650px; height: auto;" class="box">
	<form method="post" action="" id="form">
	<fieldset>
		<legend>TRA CỨU SỰ KIỆN THEO NGƯỜI NHẬN</legend>
		<table width="100%">
			<tr>
				<td class="td_label">Người nhận :</td>
				<td>
					<div style="position:relative">
					<input type="text" name="msnhanvien" id="msnhanvien" style="display:none">
					<input type="text" readonly="true" id="hotennhanvien" class="field" style="width: 150px;">
				...
				<td>
					<select name="state" class="field">
						...
						<option value="1">Chưa thông báo</option>
						<option value="2">Đã thông báo</option>
					</select>
				</td>
			</tr>
			<tr>
