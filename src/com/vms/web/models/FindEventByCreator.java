...
@NamedNativeQueries( {	
	@NamedNativeQuery(
		name = EventsServiceImpl.FIND_EVENT_BY_CREATOR, 
		query = EventsServiceImpl.SQL_FIND_EVENT_BY_CREATOR ,
		resultClass = FindEventByCreator.class,
		hints = @QueryHint(name = "org.hibernate.callable", value = "true") 
	)
})
@Entity
public class FindEventByCreator implements Serializable {
